    ...
    r(l, [], function () {
        ...
        return function (i, o) {
            ...
            i = i || {}, s.schema = o = o || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var s = this, l, c = 0, u, d, f = [], p, m, h, g, v, y, b, C, x, w, _, N, E, S, k, T, R, A, B, L, D, M, H, P, O, I = 0, F = t.decode, z, W = n.makeMap("src,href,data,background,formaction,poster"), V = /((java|vb)script|mhtml):/i, U = /^data:/i;
        ...
        return function (i) {
            ...
            function m(t, n, r) {
                ...
                function d(e, r, i) {
                    ...
                    u = h.inline || h.block, d = z.create(u), a(d), V.walk(e, function (e) {
                        ...
                        function t(e) {
                            var n, r, i;
                            if ("A" === e.nodeName) {
                                for (r = z.clone(d, G), l.push(r), i = rt(e.childNodes), n = 0; n < i.length; n++)r.appendChild(i[n]);
                                e.appendChild(r)
                            }
                ...
                if (h)if (r)r.nodeType ? (y = z.createRng(), y.setStartBefore(r), y.setEndAfter(r), d(A(y, f), null, !0)) : d(r, null, !0); else if (b && h.inline && !z.select("td.mce-item-selected,th.mce-item-selected").length)O("apply", t, n); else {
            ...
            function A(t, n, r) {
                ...
                return (n[0].inline || n[0].block_expand) && (n[0].inline && 3 == g.nodeType && 0 !== v || (g = s(!0)), n[0].inline && 3 == y.nodeType && b !== y.nodeValue.length || (y = s())), n[0].selector && n[0].expand !== G && !n[0].inline && (g = d(g, "previousSibling"), y = d(y, "nextSibling")), (n[0].block || n[0].selector) && (g = f(g, "previousSibling"), y = f(y, "nextSibling"), n[0].block && (q(g) || (g = s(!0)), q(y) || (y = s()))), 1 == g.nodeType && (v = j(g), g = g.parentNode), 1 == y.nodeType && (b = j(y) + 1, y = y.parentNode), {
                    startContainer: g,
                    startOffset: v,
                    endContainer: y,
                    endOffset: b
            ...
            function O(t, n, r) {
                ...
                function p() {
                    ...
                    if (d)if (l)s = W.getBookmark(), e.collapse(!0), e = A(e, u(n), !0), e = V.split(e), h(n, r, e), W.moveToBookmark(s); else {
        ...
        return function (a) {
            ...
            var W = o.each, V = e.BACKSPACE, U = e.DELETE, q = a.dom, $ = a.selection, j = a.settings, K = a.parser, Y = a.serializer, G = i.gecko, X = i.ie, J = i.webkit;
            C(), _(), d(), L(), J && (u(), p(), g(), S(), z(), i.iOS ? (y(), M(), H(), F()) : f()), X && i.ie < 11 && (m(), b(), x(), w(), T(), R(), A(), B()), i.ie >= 11 && (H(), I()), i.ie && (f(), O()), G && (m(), h(), v(), N(), E(), k(), D(), P())
        }
    }), r(it, [p], function (e) {
        function t() {
            return !1
            ...
            function f(n) {
                ...
                f.on("init", function () {
                    (f.inline || t.ie) && (f.on("nodechange keyup", function () {
                        ...
                        e && e.id == f.id + "_ifr" && (e = f.getBody()), d(e, f) && (f.lastRng = f.selection.getRng())
                    ...
                    window.setTimeout(function () {
                        var t = e.focusedEditor;
                        u(s()) || t != f || (f.fire("blur", {focusedEditor: null}), e.focusedEditor = null, f.selection && (f.selection.lastFocusBookmark = null))
                    }, 0)
                }), i || (i = function (t) {
        ...
        var l = t.DOM, c = i.explode, u = i.each, d = i.extend, f = 0, p, m = {
            majorVersion: "4",
            minorVersion: "0.22",
            ...
            init: function (t) {
                ...
                function a() {
                    var h, g;
                    if (l.unbind(window, "ready", a), i(t, "onpageload"), t.types)return void u(t.types, function (e) {
                        u(l.select(e.selector), function (i) {
                            r(n(i), d({}, t, e))
                        })
                    });
                    if (t.selector)return void u(l.select(t.selector), function (e) {
                        r(n(e), t)
                    });
                    switch (t.mode) {
                        case"exact":
            ...
            remove: function (e) {
                ...
                {
                    if (e) {
                        if ("string" == typeof e)return e = e.selector || e, void u(l.select(e), function (e) {
                            t.remove(r[e.id])
                        });
        ...
        return e.extend({
            recalc: function (e) {
                ...
                if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                    ...
                    if (L)for (d = 0; d < L.length; d++)B += L[d]; else B = r;
                    var D = T / B;
