...
--
-- Хост: localhost
-- Время создания: Июн 21 2015 г., 14:23
...
(1, 1, 'Про Асоціацію', 'ua', '<div>Шановні&nbsp;випускники&nbsp;Університету&nbsp;&laquo;КРОК&raquo;!<br />Наш університет вже більше двадцяти років здійснює підготовку фахівців. Щороку сотні КРОКівців під звуки Gaudeamusu отримують дипломи і крокують у самостійне життя. На нашу думку, Університет може і має стати тим ланцюжком, який буде поєднувати нас, його випускників,&nbsp;у майбутньому.<br />Саме тому у 2007 році випускниками КРОКу різних років була заснована Асоціація випускників Університету&nbsp;&laquo;КРОК&raquo;.</div>\r\n<div>&nbsp;<!-- pagebreak --></div>\r\n<div><strong>Що таке Асоціація випускників Університету&nbsp;&laquo;КРОК&raquo;?</strong><br /><br /></div>\r\n<div>Офіційно ми - Громадська організація &laquo;Асоціація випускників Університету &laquo;КРОК&raquo; (скорочено - АВУ &laquo;КРОК&raquo;).<br />В реальному житті ми розвиваємо нашу Асоціацію, як невіртуальну соціальну мережу, яка дозволяє підтримувати зв''язки тим,&nbsp;хто отримав освіту в одному університеті, на основі спільних ососбистісних та професійних, персональних та суспільних цінностей. Ми - люди&nbsp;зі спільним освітнім бекграундом, що працюють у сфері економіки, менеджменту, права, освіти. Але головне, ми маємо не тільки спільне минуле та незабутні спогади про навчання в Університеті &laquo;КРОК&raquo;, а й прагнемо примножити здобуте.</div>\r\n<div>Основні завдання Асоціації випускників Університету&nbsp;&laquo;КРОК&raquo;:</div>\r\n<ul>\r\n<li>cтворення єдиного інформаційного простору для випускників;</li>\r\n<li>організація та проведення зустрічей випускників, а також сприяння їх подальшому розвитку, освіті, спілкуванню та відпочинку;</li>\r\n<li>допомога членам Асоціації і студентам у підготовці та публікації наукових праць, отриманні грантів, стипендій тощо;</li>\r\n<li>сприяння працевлаштуванню випускників та пошук для організацій, в яких вони працюють, потенційних працівників серед студентів та випускників &laquo;КРОКу&raquo;;</li>\r\n<li>інформування членів Асоціації про проекти, що проводяться Асоціацією, а також про поточні та нові освітні програми Університету.</li>\r\n</ul>\r\n<div><strong>Для членів Асоціації випускників КРОКу:</strong></div>\r\n<ul>\r\n<li>доступ до інформаційної бази випускників Університету, яка дозволяє підтримувати контакти з друзями, налагоджувати нові професійні зв''язки;</li>\r\n<li>Програма лояльності та система знижок на освітні та інші послуги, що надає Університет &laquo;КРОК&raquo;;</li>\r\n<li>право користування університетським бібліотечним фондом;</li>\r\n<li>багато іншого за ініціативою і пропозицією членів Асоціації.</li>\r\n</ul>\r\n<div>Асоціація відкрита до співробітництва і запрошує Вас взяти участь в освітніх, кар''єрних, культурно-розважальних та інших проектах.&nbsp;</div>'),
...
(5, 'serrg1994', '827ccb0eea8a706c4c34a16891f84e7b', 2, 'no-avatar.png');
...
(3, 5, 'Serhiy', 'Borisovitch', 'Novoseletskiy', 'serhiynovos@mail.ru', '0672877665', 'Komarova');
